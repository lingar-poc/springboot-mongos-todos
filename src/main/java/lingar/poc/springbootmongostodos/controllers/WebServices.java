...
public class WebServices {
	...
	@RequestMapping(value = "/test-server", method = RequestMethod.GET) // this make it not working
	...
	// You can check this method with postman.
	@RequestMapping(value = "/todoAction", method = RequestMethod.DELETE, consumes = MediaType.TEXT_PLAIN_VALUE)
	public boolean deleteTodo(@RequestBody String id) {
		try {
